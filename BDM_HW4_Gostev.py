...
if __name__=='__main__':
	...
	places = sc.textFile(sys.argv[1] if len(sys.argv)>1 else 'hdfs:///data/share/bdm/core-places-nyc.csv') \
	...
	def MedLowHigh(x):
		...
		patterns = sc.textFile(sys.argv[1] if len(sys.argv)>1 else 'hdfs:///data/share/bdm/weekly-patterns-nyc-2019-2020.csv') \
